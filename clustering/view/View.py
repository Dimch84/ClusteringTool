...
class CentralWidget(QWidget):
    ...
    def add_dataset(self, dataset_id: uuid):
        ...
        self.windows[dataset_id] = {
            "widget": new_widget,
            "tabs_containers": list([]),
            "tabs": list([]),
            "tab_ids": list([])
        }
    ...
    def remove_results_tab_listener(self, index: int, dataset_id: uuid):
        self.presenter.remove_algo_run_pushed(self.windows[dataset_id]["tab_ids"][index])
